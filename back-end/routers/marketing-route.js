...
// by uuid
router.patch("/digital-marketing/soft-delete-user-by-id", controller.soft_delete_user_by_uuid)

// by name
router.patch("/digital-marketing/soft-delete-user-by-name", controller.soft_delete_user_by_name)
